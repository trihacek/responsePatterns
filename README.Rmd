...
Some survey participants tend to respond carelessly which complicates data analysis. This package provides functions that make it easier to explore responses and identify those that may be problematic. This package implements two approaches to the problem of careless responses detection:  
...
#Decide on how many times a respondent muset be placed above the percentile cutoff score should be considered problematic. Then, select potentially problematic responses
sum.cutoff <- 2
